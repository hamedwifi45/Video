...
class ConvertedVideoSeeder extends Seeder
{
    ...
    public function run()
    {
        $converted_video1 = ConvertedVideos::create([
        ...
        $converted_video2 = ConvertedVideos::create([
        ...
        $converted_video3 = ConvertedVideos::create([
        ...
        $converted_video4 = ConvertedVideos::create([
        ...
        $converted_video5 = ConvertedVideos::create([
        ...
        $converted_video6 = ConvertedVideos::create([
        ...
        $converted_video7 = ConvertedVideos::create([
